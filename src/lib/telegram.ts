...
export async function notifyDeposit(data: any) {
    try {
        const response = await fetch('https://bot.alert.wealthfarming.org/api/notify-deposit', {
            method: 'POST',
            headers: {
...
export async function notifyWithdrawl(data: any) {
    try {
        const response = await fetch('https://bot.alert.wealthfarming.org/api/notify-withdrawl', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json', // Specify JSON content type
            },
...
export async function notifyInvestment(data: any) {
    try {
        const response = await fetch('https://bot.alert.wealthfarming.org/api/notify-investment', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json', // Specify JSON content type
            },
            body: JSON.stringify({
                ...
                requestTime: new Date().toLocaleString('en-US', { timeZone: 'Asia/Ho_Chi_Minh' }),
                depositId: data.id,
                productLog: data.product_log.data,
...
export async function notifyWithdrawlContracts(data: any) {
    try {
        const response = await fetch('https://bot.alert.wealthfarming.org/api/notify-withdrawl-contracts', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json', // Specify JSON content type
            },
            body: JSON.stringify({
                ...
                requestTime: new Date().toLocaleString('en-US', { timeZone: 'Asia/Ho_Chi_Minh' }),
                withdrawlId: data.id,
                productLog: data.contract.product_log.data,
