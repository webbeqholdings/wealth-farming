...
import type { Contract } from "@/lib/high-light-invest-hooks"
                        ...
                        {paginatedContracts.length === 0 ? (
                            ...
                            paginatedContracts.map((contract) => (
                                <TableRow key={contract.id}>
                                    ...
                                    <TableCell>
                                        <div
                                            className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold ${contract.status === "active"
