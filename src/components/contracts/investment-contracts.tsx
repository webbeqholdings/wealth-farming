        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="  shadow-sm">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium ">{t('portfolio_cell_1')}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="  shadow-sm">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium ">{t('portfolio_cell_2')}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="  shadow-sm">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium ">{t('portfolio_cell_3')}</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold ">
          ...
          <Card className="  shadow-sm">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium ">{t('portfolio_cell_4')}</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-green-500">
                                  ...
                                  <div className="grid gap-2 ">
                                    ...
                                    <div className="grid grid-cols-4 items-center gap-4 font-medium">
                                      <Label className="col-span-2">
                                        {t('portfolio_setting_profitWithdraw')}
                                      </Label>
