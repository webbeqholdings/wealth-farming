...
export function TerminationDialogException({ isOpen, onClose, contract, setActiveTab }: TerminationDialogProps) {
        ...
        <form onSubmit={handleWithdraw}>
          ...
          <DialogFooter className="mt-6">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="px-4 py-2 rounded-md bg-slate-500 text-white hover:bg-slate-500"
            >
