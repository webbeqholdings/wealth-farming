...
import { getUserFinancialData, type FinancialData } from "@/lib/high-light-invest-hooks"
    ...
    return (
        <div className="grid gap-4 md:grid-cols-3 mb-6">
            <Card>
                ...
                <CardContent>
                    <div className="text-2xl font-bold">${financialData.totalInvestment.toLocaleString()}</div>
