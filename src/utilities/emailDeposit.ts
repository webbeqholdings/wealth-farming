...
export const sendEmailDeposit = async (to: string, subject: string, first_name: string, last_name: string, amount: Number) => {
          ...
          >
            ...
            <tr>
              <td
                ...
                "
              >
                <h1 style="color: #ffffff; font-size: 28px; margin: 0">Deposit Confirmation</h1>
              </td>
            </tr>
            <!-- Content -->
            <tr>
