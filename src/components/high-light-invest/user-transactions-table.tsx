...
import { getTransactionsByUserId, type Transaction } from "@/lib/high-light-invest-hooks"

interface UserTransactionsTableProps {
    userId: string
}

export default function UserTransactionsTable({ userId }: UserTransactionsTableProps) {
                        ...
                        {paginatedTransactions.length === 0 ? (
                            ...
                            paginatedTransactions.map((transaction) => (
                                <TableRow key={transaction.id}>
                                    ...
                                    <TableCell>
                                        <div
                                            className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold ${transaction.type === "investment" || transaction.type === "profit"
