    ...
    <div className="container mx-auto p-4">
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>Your funds have been successfully added to your account</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Your deposit has been processed and the funds are now available in your account. It may
            take a few moments for the balance to update across all services.
          </p>
        </CardContent>
