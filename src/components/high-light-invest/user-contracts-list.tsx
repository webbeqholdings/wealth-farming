...
import { getContractsByUserId, type Contract } from "@/lib/high-light-invest-hooks"
    ...
    return (
        <div className="space-y-4">
            {userContracts.length === 0 ? (
                <Card>
                    <CardContent className="p-6 text-center text-muted-foreground">No contracts found for this user.</CardContent>
                </Card>
            ) : (
                    ...
                    <Card key={contract.id} className="overflow-hidden">
                        ...
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                    <Button variant="ghost" size="sm" onClick={() => toggleContract(contract.id)} className="h-8 px-2">
                                    ...
                                    <Button variant="outline" size="sm" className="h-8" asChild>
                                        <Link href={`/high-light-invest/contracts/${contract.id}`}>
